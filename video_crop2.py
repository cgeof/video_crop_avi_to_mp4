...
class Cropper:
    def __init__(self):
        ...
        self.newFileName = os.path.join(str(Path(self.videofile).parents[0]), str(Path(self.videofile).stem) +'_cropped-2.mp4')
        ...
        self.out = cv2.VideoWriter(self.newFileName, cv2.VideoWriter_fourcc('M','P','4','V'), self.fps, (self.frame_width,self.frame_height))
